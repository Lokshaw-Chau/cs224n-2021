...
def minibatch_parse(sentences, model, batch_size):
    ...
    while unfinished_parses:
        ...
        for i in range(len(transitions)):
            ...
            if not batch_parses[i].buffer and len(batch_parses[i].stack) == 1:
                dependencies[partial_parses.index(batch_parses[i])] = batch_parses[i].dependencies
                del unfinished_parses[unfinished_parses.index(batch_parses[i])]
